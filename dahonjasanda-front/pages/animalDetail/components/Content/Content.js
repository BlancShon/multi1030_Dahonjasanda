  ...
  const mock = [
    {
      ...
      description:
        '스페셜마크 소개 부정교합. 코갈색. 낑낑댐/사람좋아함. 꼬리단미안됨 ',
      title: '품종 입력 말티즈',
      age: '나이 입력 2020년생',
      weight: '몸무게',
      happenPlace: '발견 장소 장흥면 유원지로 89번길 90 인근',
      happenDt: '발견 일자 20211231',
      sex: '성별 M',
      author: {
        name: '식물 치료 센터 바로가기 ',
  ...
  const photos = [
    {
      ...
      src: 'http://www.animal.go.kr/files/shelter/2021/12/202201031501804.jpg',
      rows: 1,
      cols: 2,
    },
    {
