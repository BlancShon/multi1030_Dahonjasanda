...
export default function List() {
    ...
    return (
        <>
            {/* <section id="content"> */}
                <div id="board-list-container" style={{ backgroundColor: 'white' }}>
                    ...
                    <form name="searchForm" onSubmit={onSubmit} tyle={{marginBottom:10}} >
                        ...
                        <Box className="searchInput" style={{ textAlign: 'center'}}>
                            <label>
                            ...
                            color="primary"
                            size="medium" style={{ marginLeft: 5 }} type="submit" className="sch_smit">검색</Button>
                    </Box>
                    </form>
                    {loginInfo != null 
